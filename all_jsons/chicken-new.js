window.onload = function() {
    var animations = [        
        './chicken_new_animations/1_Inspect_Egg.json',
        './chicken_new_animations/2_Day_2.json',
        './chicken_new_animations/3_Day_3.json',
        './chicken_new_animations/4_Day_4.json',
        './chicken_new_animations/5_Day_5.json',
        './chicken_new_animations/6_Day_6.json',
        './chicken_new_animations/7_Day_7.json',
        './chicken_new_animations/8_Day_8.json',
        './chicken_new_animations/9_Day_9.json',
        './chicken_new_animations/10_Day_10.json',
        './chicken_new_animations/11_Day_11.json',
        './chicken_new_animations/12_Day_12.json',
        './chicken_new_animations/13_Day_13.json',
        './chicken_new_animations/14_Day_14.json',
        './chicken_new_animations/15_Day_15.json',
        './chicken_new_animations/16_Day_16.json',
        './chicken_new_animations/17_Day_17.json',
        './chicken_new_animations/18_Day_18.json',
        './chicken_new_animations/19_Day_19.json',
        './chicken_new_animations/20_Day_20.json',
        './chicken_new_animations/21_Day_21.json'        
    ];
    var procedures = [ 
        'Day 1',
        'Day 2',
